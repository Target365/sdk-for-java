...
Select "Java" as your SDK. Copy and store the "Private key-string" safe and encrypted (we recommend EAS-encryption). We only store the public-key.
...
### Gradle
```
implementation 'com.github.target365:target-365-sdk:1.9.0'
```
