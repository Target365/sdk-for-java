...
* The final redirect happens in end users browser, meaning we do not see final result on same. We recommend merchants to include a unique parameter in each forward to OneClick and do lookup on them not redirected to ensure success or failure.
